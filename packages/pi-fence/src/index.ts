 ...
 * Edits whose oldText is not found in base are skipped gracefully.
 */
function applyEdits(
  base: string,
  ...
  // Forward pass: compute each edit's start line in patchedContent, accounting
  // for line-count changes introduced by earlier edits in the file.
  let accLineDelta = 0;
